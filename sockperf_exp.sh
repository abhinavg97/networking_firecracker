...
do
    ...
    do
        ...
        valuefournine=$(ssh -i rootfs.id_rsa root@$SRC_VM_IP "cat sockperf_${VM_INDEX}" | grep "percentile 99.990" | awk '{print $6}')
        valuethreenine=$(ssh -i rootfs.id_rsa root@$SRC_VM_IP "cat sockperf_${VM_INDEX}" | grep "percentile 99.900" | awk '{print $6}')
        valuetwonine=$(ssh -i rootfs.id_rsa root@$SRC_VM_IP "cat sockperf_${VM_INDEX}" | grep "percentile 99.000" | awk '{print $6}')
        valueonenine=$(ssh -i rootfs.id_rsa root@$SRC_VM_IP "cat sockperf_${VM_INDEX}" | grep "percentile 90.000" | awk '{print $6}')
        valuesevenfive=$(ssh -i rootfs.id_rsa root@$SRC_VM_IP "cat sockperf_${VM_INDEX}" | grep "percentile 75.000" | awk '{print $6}')
        valuefivezero=$(ssh -i rootfs.id_rsa root@$SRC_VM_IP "cat sockperf_${VM_INDEX}" | grep "percentile 50.000" | awk '{print $6}')
        valuetwofive=$(ssh -i rootfs.id_rsa root@$SRC_VM_IP "cat sockperf_${VM_INDEX}" | grep "percentile 25.000" | awk '{print $6}')
