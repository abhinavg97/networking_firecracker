if [ "$#" -ne 7 ]
then
  echo "run like: ping_exp.sh [MIN_SRC_VMS]1 [MIN_TARGET_VMS]1 [TOTAL_SOURCE_VMS]10 [TOTAL_TARGET_VMS]10 [TARGET_NODE_IP]10.10.1.1 [SOURCE_BRIDGE_PREFIX]192.167 [TARGET_BRIDGE_PREFIX]192.168"
  exit 1
fi
